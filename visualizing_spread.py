...
def draw():
    ...
    if highlight_infecting_edges:
        ...
        infecting_edges = [e for e in time_networks[time].edges if ((e[0] in newly_infected_nodes)
                                                                    ...
                                                                    and ((e[1] in newly_infected_nodes)) #or
                                                                    #(e[0] in previously_infected_nodes)
                                                                    #and ((e[1] in previously_infected_nodes))
                                                                    )]
        ...
        NX.draw_networkx_edges(G, positions, edgelist=infecting_edges, edge_color='w', width=1, alpha=1)
...
if __name__ == '__main__':
    ...
    if do_computations:
        dynamics = HeterogeneousUnravelingModel(simulator_params)
